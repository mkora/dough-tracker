...
class ApiController
{
    ...
    /**
     * Send a full list of categories
     *
    ...
    /**
     * Send a list of all transactions
     * that was made on a specified month
     *
     * @param IRequest  $request  request
     * @param IResponse $response response
     * @param array     $args     get parameters
    ...
    public function getDataDetails(
        ...
        try {
            ...
            $query = [
                'success' => false,
                'msg' => "Something went wrong! Check out logs/app.log",
            ];
    ...
    /**
     * Send a sum that was spend/earn
    ...
    /**
     * Send a table of all sums by categories
     * and/or years and/or months
     *
     * @param IRequest  $request  request
     * @param IResponse $response response
     * @param array     $args     get parameters
